...
{ const h = new URLSearchParams(location.hash.slice(1)); const t = h.get('token'); if (t) { localStorage.setItem('lm_token', t); history.replaceState(null, '', location.pathname); } } // 双击启动带 #token= 直达
