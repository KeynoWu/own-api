...
const triple = platform() === 'darwin' ? (targetArch === 'arm64' ? 'aarch64-apple-darwin' : 'x86_64-apple-darwin') : isWin ? 'x86_64-pc-windows-msvc' : 'x86_64-unknown-linux-gnu';
const src = `dist/own-api-${targetArch}${isWin ? '.exe' : ''}`;
